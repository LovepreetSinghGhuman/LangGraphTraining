...
doc_path = 'doc/Stock_Market_Performance_2024.pdf'

# Safety measure I have put for debugging purposes :)
if not os.path.exists(doc_path):
    raise FileNotFoundError(f"Document not found: {doc_path}")

pdf_loader = PyPDFLoader(doc_path) # This loads the PDF
...
persist_directory = r"db/chroma"  # Directory to persist the ChromaDB
...
class AgentState(TypedDict):
    messages: Annotated[Sequence[BaseMessage], "The current messages in the conversation."]
